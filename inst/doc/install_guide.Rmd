...
1. Install it via `brew install grass6` from the 'osgeo4mac' tap
...
Next add the correct repository to sources.list. Here, we use the QGIS long-term release (2.14) (for QGIS 2.18, we would have to use http://qgis.org/ubuntugis instead of http://qgis.org/ubuntugis-ltr):
