...
Next add the correct repository to `/etc/apt/sources.list`. Here, we use the QGIS long-term release (2.14) (for QGIS 2.18, we would have to use http://qgis.org/ubuntugis instead of http://qgis.org/ubuntugis-ltr):
